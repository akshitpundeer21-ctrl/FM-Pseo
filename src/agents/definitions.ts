...
export const AGENT_DEFINITIONS: AgentDefinition[] = [
  {
    ...
    kind: "ORCHESTRATOR",
    allowedTools: [TOOL_KEYS.llmGenerate, TOOL_KEYS.travelReference, TOOL_KEYS.sheetsRead, TOOL_KEYS.sheetsUpdate],
    capabilities: [
      "read_project",
      "request_approval",
      "call_llm",
      ...
      // Reading the job queue and writing status back are external API calls.
      "call_external_api",
    ],
  ...
  },
  {
    ...
    kind: "SPECIALIST",
    allowedTools: [TOOL_KEYS.publish, TOOL_KEYS.unpublish, TOOL_KEYS.githubPublish, TOOL_KEYS.githubUnpublish],
